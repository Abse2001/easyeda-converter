...
it("should convert C46497 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-1021.8888000000001,"y":757.3303999999999},{"x":-1010.162,"y":757.3303999999999},{"x":-1010.162,"y":766.8474},{"x":-1021.8888000000001,"y":766.8474},{"x":-1021.8888000000001,"y":757.3303999999999}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=01398eb211cd42de99baf7928a6338ec&pn=C46497",
            rotationOffset: { x: 0, y: 0, z: 90 },
            positionOffset: { x: 0, y: 0, z: 0.099083 },
          }}
          {...props}
        />
      )
