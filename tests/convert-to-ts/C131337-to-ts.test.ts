...
it("should convert C131337 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-1019.6215960000002,"y":758.0924},{"x":-1013.076396,"y":758.0924},{"x":-1013.076396,"y":763.1897999999999},{"x":-1019.6215960000002,"y":763.1897999999999},{"x":-1019.6215960000002,"y":758.0924}]} />
          </footprint>}
          cadModel={{
            ...
            positionOffset: { x: 0, y: 0, z: 0.000006999999999646178 },
          }}
          {...props}
        />
      )
