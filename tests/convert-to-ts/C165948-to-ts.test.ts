...
it("should convert C165948 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <hole pcbX="2.8999180000000706mm" pcbY="0.9055671999999504mm" diameter="0.7500111999999999mm" />
    <platedhole  portHints={["pin2"]} pcbX="4.32511199999999mm" pcbY="-2.7741307999999663mm" holeWidth="0.7999983999999999mm" holeHeight="1.3999972mm" outerWidth="1.1999975999999999mm" outerHeight="1.7999964mm" shape="pill" />
    <platedhole  portHints={["pin1"]} pcbX="4.32511199999999mm" pcbY="1.4056931999998596mm" holeWidth="0.7999983999999999mm" holeHeight="1.5999968mm" outerWidth="1.1999975999999999mm" outerHeight="1.9999959999999999mm" shape="pill" />
    <platedhole  portHints={["pin4"]} pcbX="-4.32511199999999mm" pcbY="1.4056931999998596mm" holeWidth="0.7999983999999999mm" holeHeight="1.5999968mm" outerWidth="1.1999975999999999mm" outerHeight="1.9999959999999999mm" shape="pill" />
    <platedhole  portHints={["pin3"]} pcbX="-4.32511199999999mm" pcbY="-2.7741307999999663mm" holeWidth="0.7999983999999999mm" holeHeight="1.3999972mm" outerWidth="1.1999975999999999mm" outerHeight="1.7999964mm" shape="pill" />
    ...
    <courtyardoutline points={[{"x":-1021.3498119999998,"y":757.9654},{"x":-1010.9946119999998,"y":757.9654},{"x":-1010.9946119999998,"y":766.6949999999999},{"x":-1021.3498119999998,"y":766.6949999999999},{"x":-1021.3498119999998,"y":757.9654}]} />
          </footprint>}
          cadModel={{
            ...
            positionOffset: { x: 0, y: 0, z: -0.000010999999999872223 },
          }}
          {...props}
        />
      )
