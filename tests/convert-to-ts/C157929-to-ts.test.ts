...
it("should convert C157929 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-1019.5916240000001,"y":758.8543999999999},{"x":-1011.0906240000002,"y":758.8543999999999},{"x":-1011.0906240000002,"y":766.9997999999999},{"x":-1019.5916240000001,"y":766.9997999999999},{"x":-1019.5916240000001,"y":758.8543999999999}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=34ff8836248648119b083f641041fec0&pn=C157929",
            rotationOffset: { x: 0, y: 0, z: 0 },
            positionOffset: { x: 0, y: 0, z: -0.09999300000000044 },
          }}
          {...props}
        />
      )
