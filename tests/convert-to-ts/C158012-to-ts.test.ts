...
it("should convert C158012 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-1020.0600254000002,"y":758.194},{"x":-1011.9400254000002,"y":758.194},{"x":-1011.9400254000002,"y":764.79},{"x":-1020.0600254000002,"y":764.79},{"x":-1020.0600254000002,"y":758.194}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=417e395cbf3443fdb9642576696e80a3&pn=C158012",
            rotationOffset: { x: 0, y: 0, z: 180 },
            positionOffset: { x: 0, y: 0, z: 1.800005 },
          }}
          {...props}
        />
      )
