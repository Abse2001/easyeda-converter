...
it("should convert C2998002 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-103.14514600000001,"y":74.2482},{"x":-99.74954600000001,"y":74.2482},{"x":-99.74954600000001,"y":78.2026},{"x":-103.14514600000001,"y":78.2026},{"x":-103.14514600000001,"y":74.2482}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=499fe0b8a844428c9e2aff62131a11f8&pn=C2998002",
