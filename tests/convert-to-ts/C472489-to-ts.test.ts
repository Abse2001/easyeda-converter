...
it("should convert C472489 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-154.75820000000002,"y":-72.6908},{"x":-141.65980000000002,"y":-72.6908},{"x":-141.65980000000002,"y":-59.44},{"x":-154.75820000000002,"y":-59.44},{"x":-154.75820000000002,"y":-72.6908}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=7e9b9111dcfd48d3add0eab11d882721&pn=C472489",
            rotationOffset: { x: 0, y: 0, z: 0 },
            positionOffset: { x: 0, y: 0, z: 0.000795 },
          }}
          {...props}
        />
      )
