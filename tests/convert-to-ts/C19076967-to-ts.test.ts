...
it("should convert C19076967 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-1032.303562,"y":745.7226},{"x":-999.7487620000002,"y":745.7226},{"x":-999.7487620000002,"y":778.2774},{"x":-1032.303562,"y":778.2774},{"x":-1032.303562,"y":745.7226}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=b6d9880015ca4fcf86b410816d650f7b&pn=C19076967",
            rotationOffset: { x: 0, y: 0, z: 0 },
            positionOffset: { x: 0, y: 0, z: 0.000009000000000369823 },
          }}
          {...props}
        />
      )
