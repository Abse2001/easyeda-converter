...
it("should convert C75749 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-225.98437200000004,"y":-137.7656},{"x":-206.61217200000004,"y":-137.7656},{"x":-206.61217200000004,"y":-106.20139999999998},{"x":-225.98437200000004,"y":-106.20139999999998},{"x":-225.98437200000004,"y":-137.7656}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=dc634ef6f677426f9bef12d13c1b02cd&pn=C75749",
            rotationOffset: { x: 0, y: 0, z: 90 },
            positionOffset: { x: 0, y: 0, z: -0.3381490000000005 },
          }}
          {...props}
        />
      )
