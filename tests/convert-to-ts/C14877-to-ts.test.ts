...
it("should convert C14877 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-95.6524,"y":-113.407},{"x":-85.1956,"y":-113.407},{"x":-85.1956,"y":-102.97559999999999},{"x":-95.6524,"y":-102.97559999999999},{"x":-95.6524,"y":-113.407}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=4d9f6c3430024506b87ce44b53201fc5&pn=C14877",
            rotationOffset: { x: 0, y: 0, z: 90 },
            positionOffset: { x: 0, y: 0, z: 0.000917 },
          }}
          {...props}
        />
      )
