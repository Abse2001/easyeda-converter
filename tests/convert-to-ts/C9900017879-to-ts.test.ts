...
it("should convert C9900017879 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-143.35359999999997,"y":59.33839999999999},{"x":-97.41299999999998,"y":59.33839999999999},{"x":-97.41299999999998,"y":77.847},{"x":-143.35359999999997,"y":77.847},{"x":-143.35359999999997,"y":59.33839999999999}]} />
          </footprint>}
          cadModel={{
            ...
            positionOffset: { x: 0, y: 0, z: 2.5000069999999996 },
          }}
          {...props}
        />
      )
