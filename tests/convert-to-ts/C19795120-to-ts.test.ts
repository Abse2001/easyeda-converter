...
it("should convert C19795120 into typescript file", async () => {
  ...
  expect(result).toMatchInlineSnapshot(`
    ...
    <courtyardoutline points={[{"x":-1025.1908,"y":758.448},{"x":-1014.4546,"y":758.448},{"x":-1014.4546,"y":765.298},{"x":-1025.1908,"y":765.298},{"x":-1025.1908,"y":758.448}]} />
          </footprint>}
          cadModel={{
            objUrl: "https://modelcdn.tscircuit.com/easyeda_models/download?uuid=9a93067adc7a4c82860f56e3024924ad&pn=C19795120",
            rotationOffset: { x: 0, y: 0, z: 0 },
            positionOffset: { x: 0, y: 0, z: 3.295008 },
          }}
          {...props}
        />
      )
